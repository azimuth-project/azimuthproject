...
public class Force implements IForce2DCartesian
{
	...
	/* (non-Javadoc)
	 * @see com.azimuth.hopfbifurcation.euler.cartesian.IForce2DCartesian#getXForce(com.azimuth.geometry.Point2D)
	 */
	...
	/* (non-Javadoc)
	 * @see com.azimuth.hopfbifurcation.euler.cartesian.IForce2DCartesian#getYForce(com.azimuth.geometry.Point2D)
	 */
